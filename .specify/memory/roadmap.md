...
Each section below is scoped as a separate feature specification.

---

## Feature 1: Baseline Model Comparison

**Spec name suggestion**: `05c-baseline-comparison-spec.md`
...
## Feature 2: Spatial Cross-Validation

**Spec name suggestion**: `05d-spatial-cv-spec.md`
...
## Feature 3: Model Diagnostics & Effect Interpretation

**Spec name suggestion**: `05e-diagnostics-interpretation-spec.md`
...
## Suggested Order
1. **Feature 3 (Diagnostics)** - Quick wins, can run on existing models, may inform interpretation
2. **Feature 1 (Baseline Comparison)** - Core research question, straightforward to implement
3. **Feature 2 (Spatial CV)** - Important for generalization claims, slightly more involved
...
## Dependencies
- Feature 1 and 2 are independent (can be done in parallel)
- Feature 3 can run on existing models immediately
