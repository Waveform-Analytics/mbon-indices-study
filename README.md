...
├── data/
│   ├── raw/                      # Original data (not included — contact Eric Montie at USCB)
...
Raw data is **not included** in this repository. To request access, contact **Eric Montie** at the University of South Carolina Beaufort.

Once you have the data, place it under `data/raw/` with this structure:

| Folder | Contents |
|--------|----------|
| `data/raw/2018/` | Detections, environment, SPL (Excel) |
| `data/raw/2021/` | Detections, environment, SPL (Excel) |
| `data/raw/indices/` | Acoustic index CSVs (3 stations × 2 bands) |
| `data/raw/metadata/` | Column mappings, index metadata |

Intermediate and processed data (`data/interim/`, `data/processed/`) are regenerated by the pipeline.
